function [C, Gamma, PiX, Lambda, it, stats, L] = adamar_kmeans(X, PiY, K, epsilon, maxIters, Nrand, scaleT)
%KMEANS_ADAMAR 
arguments
...
for nrand = 1:Nrand
    ...
    adamar_kmeans_one(C0, Gamma0, Lambda0, PiY, X, K, epsilon, maxIters, scaleT);
...
function [C, Gamma, PiX, Lambda, it, stats, L_out]...
    = adamar_kmeans_one(C, Gamma, Lambda, PiY, X, K, epsilon, maxIters, scaleT)
